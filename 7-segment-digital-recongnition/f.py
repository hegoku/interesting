...
plt.subplot(3,5,12),plt.imshow(number_image[0][2],'gray')
i=0
for i in range(len(tmp[0])):
	plt.subplot(3,5,j),plt.imshow(tmp[0][i],'gray'),plt.title(str(cv2.matchShapes(number_image[1][2],tmp[1][i],2,0.0)))
